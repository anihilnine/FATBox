...
namespace FATBox.Core.MapScmap
{
    ...
    public class ScmapContent
    {
        ...
        public Texture PreviewTex{ get; set; }
        private short[] HeightmapData{ get; set; }
        public short HeightMin{ get; set; }
        public short HeightMax{ get; set; }

        public short HeightDiff{ get; set; }

        public WaterShader Water{ get; set; }
        //texturemap for the "Strata" layers
        public Texture TexturemapTex{ get; set; }
        public Texture TexturemapTex2{ get; set; }
        public Texture NormalmapTex{ get; set; }

        public Texture WatermapTex{ get; set; }
        public byte[] WaterFoamMask{ get; set; }
        public byte[] WaterFlatnessMask{ get; set; }

        public byte[] WaterDepthBiasMask { get; set; }
        public int Width  { get; set; }
        public int Height { get; set; }

        public string TexPathBackground{ get; set; }
        public string TexPathSkyCubemap{ get; set; }
        public string[] EnvCubemapsName{ get; set; }

        public string[] EnvCubemapsFile{ get; set; }
        ...
        public List<IntegerGroup> DecalGroups{ get; set; }
        ...
        public float LightingMultiplier{ get; set; }
        public Vector3 SunDirection{ get; set; }
        public Vector3 SunAmbience{ get; set; }
        public Vector3 SunColor{ get; set; }
        public Vector3 ShadowFillColor{ get; set; }
        ...
        public int MinimapContourInterval{ get; set; }
        public Color MinimapDeepWaterColor{ get; set; }
        public Color MinimapShoreColor{ get; set; }
        public Color MinimapLandStartColor{ get; set; }
